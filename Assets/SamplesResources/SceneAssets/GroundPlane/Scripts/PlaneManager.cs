...
public class PlaneManager : MonoBehaviour
{
    ...
    public static bool AnchorExists { get; private set; }
    #endregion // PUBLIC_MEMBERS


    #region PRIVATE_MEMBERS
    [SerializeField] PlaneFinderBehaviour planeFinder;
    [SerializeField] MidAirPositionerBehaviour midAirPositioner;
    ...
    void Update()
    {
        ...
        // HandleAutomaticHitTest() callback method. When the Update() method
    ...
    public void ResetTrackers()
    {
        ...
        // StopService and restart trackers
    ...
    /// <summary>
    /// This private method deletes the existing anchors and resets the AnchorExists boolean.
    /// It is called by the ResetScene() method.
    /// </summary>
    void DeleteAnchors()
    {
        this.planeAnchor.UnConfigureAnchor();
        this.midAirAnchor.UnConfigureAnchor();
        this.placementAnchor.UnConfigureAnchor();
        AnchorExists = DoAnchorsExist();
    }
    ...
    /// <summary>
    /// Checks if at least one AnchorBehaviour exists and returns true if so.
    /// </summary>
    bool DoAnchorsExist()
    {
        ...
        {
            IEnumerable<TrackableBehaviour> trackableBehaviours = this.stateManager.GetActiveTrackableBehaviours();
    ...
    void OnDevicePoseStatusChanged(TrackableBehaviour.Status status, TrackableBehaviour.StatusInfo statusInfo)
    {
        ...
        switch (statusInfo)
        {
            ...
            case TrackableBehaviour.StatusInfo.RELOCALIZING:
                // StartService a 10 second timer to Reset Device Tracker
